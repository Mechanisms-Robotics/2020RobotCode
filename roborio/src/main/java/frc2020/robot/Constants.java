...
//    }
    ...
    public final static int INTAKE_OUTTAKE_BUTTON2 = 10; // right second
    ...
    public final static int ADJUST_HOOD_HIGHER_BUTTON = 7; // left second
    public final static int MANUAL_CONTROL_BUTTON_2 = 13; //left second
    public final static int ADJUST_HOOD_LOWER_BUTTON = 8; // left second
