...
public class BarrelRacing extends AutoMode {
  ...
  private static Trajectory barrelRacingTrajectory = null;
  ...
  public static void generateTrajectories() {
    ...
    // TODO: Convert to quintic spline
    ...
    barrelRacingTrajectory = TrajectoryGenerator.generateTrajectory(
        startPose, midPoints, endPose, config);
  }

  @Override
  protected void routine() throws AutoModeEndedException {
    if (barrelRacingTrajectory == null) {
      generateTrajectories();
    }
    runCommand(new DriveTrajectory(barrelRacingTrajectory));
  }
}