...
public class slalom extends AutoMode {
    ...
    public static void generateTrajectories() {
        ...
        var midPoint1 = new Translation2d(1.52, .76);
        var midPoint2 = new Translation2d(2.29, 1.52);
        var midPoint3 = new Translation2d(5.33, 1.52);
        var midPoint4 = new Translation2d(6.1, .76);
        var midPoint5 = new Translation2d(6.89, 0);
        var midPoint6 = new Translation2d(7.62, .76);
        var midPoint7 = new Translation2d(6.89, 1.52);
        var midPoint8 = new Translation2d(6.1, .76);
        var midPoint9 = new Translation2d(5.33, 0);
        var midPoint10 = new Translation2d(2.29, 0);
        var midPoint11 = new Translation2d(.76, 1.52);
